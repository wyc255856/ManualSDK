...
public class SortFastDetailFragment extends BaseListFragment<SortDetailPresenter, String> implements CheckListener {
    ...
    @SuppressLint("ValidFragment")
    public SortFastDetailFragment() {

    }
    @SuppressLint("ValidFragment")
    public SortFastDetailFragment(List<NewsListModel> newsList, List<CategoryModel> list) {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_sort_fast_detail;
    }

    @Override
    protected void initCustomView(View view) {
        mRv = (RecyclerView) view.findViewById(R.id.rv_fast);

    }

    @Override
    protected void initListener() {
        mRv.addOnScrollListener(new SortFastDetailFragment.RecyclerViewListener());
    }
    ...
    protected SortDetailPresenter initPresenter() {
        ...
        mAdapter = new ClassifyDetailAdapter(mContext, mDatas, new RvListener() {
            ...
            public void onItemClick(int id, int position) {
                ...
                newsModel.setContent1_app(rightBean.getContent1_app());
                newsModel.setContent2_app(rightBean.getContent2_app());
                newsModel.setContent3_app(rightBean.getContent3_app());
                newsModel.setContent4_app(rightBean.getContent4_app());
                newsModel.setContent5_app(rightBean.getContent5_app());
                newsModel.setContent6_app(rightBean.getContent6_app());
                newsModel.setContent7_app(rightBean.getContent7_app());
                newsModel.setContent8_app(rightBean.getContent8_app());
                newsModel.setContent9_app(rightBean.getContent9_app());
                newsModel.setContent10_app(rightBean.getContent10_app());
    ...
    private void initData() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            for (int j = 0; j < categoryTwoArray.size(); j++) {
                ...
                body.setContent1_app(categoryTwoArray.get(j).getContent1_app());
                body.setContent2_app(categoryTwoArray.get(j).getContent2_app());
                body.setContent3_app(categoryTwoArray.get(j).getContent3_app());
                body.setContent4_app(categoryTwoArray.get(j).getContent4_app());
                body.setContent5_app(categoryTwoArray.get(j).getContent5_app());
                body.setContent6_app(categoryTwoArray.get(j).getContent6_app());
                body.setContent7_app(categoryTwoArray.get(j).getContent7_app());
                body.setContent8_app(categoryTwoArray.get(j).getContent8_app());
                body.setContent9_app(categoryTwoArray.get(j).getContent9_app());
                body.setContent10_app(categoryTwoArray.get(j).getContent10_app());
