...
import com.faw.hongqi.widget.BasePresenter;
import com.faw.hongqi.widget.FlexibleLayout;
import com.faw.hongqi.widget.ViewCallBack;

public abstract class BaseListFragment <T extends BasePresenter, V> extends Fragment implements View.OnClickListener, ViewCallBack<V> {
    public T presenter;
