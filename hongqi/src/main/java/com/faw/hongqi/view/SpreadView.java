...
public class SpreadView extends View {
    ...
    public SpreadView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int centerColor = a.getColor(R.styleable.SpreadView_spread_center_color, ContextCompat.getColor(context, R.color.theme1_text_color_white));
        int spreadColor = a.getColor(R.styleable.SpreadView_spread_spread_color, ContextCompat.getColor(context, R.color.theme1_text_color_white));
