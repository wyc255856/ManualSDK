...
//            BaseModelItem baseModelItem9 = new BaseModelItem(mContext, "190", mContext.getString(R.string.model_item_text_9), R.mipmap.test_point_view_icon_7);
            BaseModelItem baseModelItem1 = new BaseModelItem(mContext, "149", mContext.getString(R.string.model_item_text_1), R.mipmap.test_point_view_icon_2);
            BaseModelItem baseModelItem2 = new BaseModelItem(mContext, "255", mContext.getString(R.string.model_item_text_11), R.mipmap.test_point_view_icon_8);
            BaseModelItem baseModelItem3 = new BaseModelItem(mContext, "36", mContext.getString(R.string.model_item_text_3), R.mipmap.test_point_view_icon_4);
            BaseModelItem baseModelItem4 = new BaseModelItem(mContext, "89", mContext.getString(R.string.model_item_text_4), R.mipmap.test_point_view_icon_6);
            BaseModelItem baseModelItem5 = new BaseModelItem(mContext, "20", mContext.getString(R.string.model_item_text_5), R.mipmap.test_point_view_icon_5);
            BaseModelItem baseModelItem6 = new BaseModelItem(mContext, "86", mContext.getString(R.string.model_item_text_6), R.mipmap.test_point_view_icon_l);
            BaseModelItem baseModelItem7 = new BaseModelItem(mContext, "47", mContext.getString(R.string.model_item_text_10), R.mipmap.test_point_view_icon_9);
            BaseModelItem baseModelItem8 = new BaseModelItem(mContext, "17", mContext.getString(R.string.model_item_text_8), R.mipmap.test_point_view_icon_3);
            BaseModelItem baseModelItem9 = new BaseModelItem(mContext, "16", mContext.getString(R.string.model_item_text_9), R.mipmap.test_point_view_icon_7);
