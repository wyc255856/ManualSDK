	...
	function myprivate() {
		...
		host_1.onclick = function(e) {
			...
			if (typeof anim == 'undefined') {
				...
				var host_list = [{
					'text': '高级巡航功能',
					'id': '70d68ac1-b697-42d3-bde1-b449737e1945'
				}];
		...
		host_2.onclick = function(e) {
			...
			if (typeof anim == 'undefined') {
				...
				var host_list = [{
					'text': '座椅记忆',
					'id': '542eb5dd-6494-4d1f-b554-731a941e5097'
				}];
		...
		host_3.onclick = function(e) {
			...
			if (typeof anim == 'undefined') {
				...
				var host_list = [{
					'text': '前碰撞预警',
					'id': 'c11b2697-0b51-4c2c-b765-160319167755'
				}, {
					'text': '主动紧急制动',
					'id': '844d728f-f385-4762-95e5-fb0c7511a04a'
				}, {
					'text': '盲区探测',
					'id': '594ea766-56e8-463d-95ff-095803e475b6'
				}, {
					'text': '驾驶模式',
					'id': '9a64874b-a6c5-4dd9-9bfa-a132379c3e78'
				}];
		...
		host_4.onclick = function(e) {
			...
			if (typeof anim == 'undefined') {
				...
				var host_list = [{
					'text': '全景影像',
					'id': 'a23ff666-76f9-4c70-97c6-8d46df9c6a94'
				}, {
					'text': '自动泊车',
					'id': 'ff544bfe-b88e-41f3-a7be-bb9352d3c2c8'
				}];
